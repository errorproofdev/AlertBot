...
CVES_JSON_PATH = join(pathlib.Path(__file__).parent.absolute(), "output/alertbot.json")
...
KEYWORDS_CONFIG_PATH = join(pathlib.Path(__file__).parent.absolute(), "config/alertbot.yaml")
ALL_VALID = False
